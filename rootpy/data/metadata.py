...
def find_sample(samplename, treetype, datasets, objects, label=None,
                classtype=None, datatype=None, tree_paths=None):
    """
    ...
    for key, value in datasets.items():
        ...
        if key == samplename:
            ...
            find_sample(samplename, treetype, value, objects, label,
                        classtype, datatype, tree_paths)
    return tree_paths, label, classtype, datatype


def _recurse_find_trees(treetype, datasets, parent, objects, tree_paths):
    """
    Recursively find all trees of type treetype
